...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://imgur.com/a/VxVtR7a.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "PHOENUX MD",
    BOT_NAME: process.env.BOT_NAME || 'PHOENIX MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Raganork MD bot;https://imgur.com/a/VxVtR7a.jpeg' : process.env.AUDIO_DATA,
