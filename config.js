...
module.exports = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "PHOENIX MD",
    BOT_NAME: process.env.BOT_NAME || 'PHOENIX MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'PHOENIX MD bot;https://imgur.com/a/VxVtR7a.jpeg' : process.env.AUDIO_DATA,
